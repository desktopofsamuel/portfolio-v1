...
<div>
    ...
    <div className="Hero AlignCenter Full-Width">
      ...
      <div className="Container">
        <div className="TextContainer Padding-S">
          ...
          <h3>My name is <strong>Samuel</strong>.<br/>I love to solve problem with design.</h3>
          <p>I'm currently working at <a href="https://playa.hk">Playa</a>, a web / app agency that I've founded in Hong Kong, crafting projects like <Link to="/waterforfree">Water For Free</Link> and <Link to="/hyperair">Hyperair</Link>. Before that, I was the cross-content intern at iTunes & App Store.</p>
        </div>
      </div>
    </div>
    ...
    <h2 className="SectionTitle Green">My skills</h2>
      <Skill
        image={require('../images/coffee.png')}
        title="UI Design"
        text="I come up with elegant and practical Web & App interface design and execute them."
      > </Skill>
      <Skill
        image={require('../images/coffee.png')}
        title="Product Development"
        text="I help converting rough ideas into sketches and wireframes, drafting up a viable specification for execution."
      ></Skill>
      <h5>I also help with</h5>
      <Skill
        image={require('../images/coffee.png')}
        title="Brand Design"
        text="I help start-ups and NGO to shape their identity."
      ></Skill>
    </div>
    </section>
          ...
          <h2 className="SectionTitle Green">Selected Work</h2>
            ...
            {data.PortfolioIndex.edges.map(post => (
                <div className="PortfolioIndex Padding-S">
                  ...
                  <div className="PortfolioIndexGroup">
